...
#| warning: false
#| message: false
#| label: fig-subtype-graph
#| fig-cap: "Victims Count by Crime Subtype Over the Years"
...
# Assuming 'pivoted_table_2' is the table with Assault, Sexual Violation, Robbery columns from the above table code

# Create bar graphs for each crime subtype
bar_plot <- ggplot(pivoted_table_2, aes(x = REPORT_YEAR)) +
