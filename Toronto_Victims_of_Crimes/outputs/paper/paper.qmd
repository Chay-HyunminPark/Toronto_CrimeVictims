...
bar_plot <- ggplot(pivoted_table, aes(x = REPORT_YEAR)) +
  ...
  labs(title = "Number of Reported Crimes in Different Age Group Over the Years",
       x = "Year",
...
# Print the table using knitr
kable(pivoted_table, format = "markdown", caption = "Table for Victims Count by Crime Subtype Over the Years")
